...
if($_SESSION['ostatnie'][0] !== "Już niedługo Pokemon Z-A" && $_SESSION['ostatnie'][1] !== "Już niedługo Pokemon Z-A" && $_SESSION['ostatnie'][2] !== "Już niedługo Pokemon Z-A") {
    ...
    $_SESSION['ostatnie'][0] = "Już niedługo Pokemon Z-A";
    $_SESSION['link'][0] = "pokemonza.php";
}

$info1 = mysqli_fetch_row(mysqli_query($conn, "SELECT nazwa, link, nazwa_pliku, il_akapitow, akapit1, akapit2, akapit3, akapit4, akapit5 FROM artykuly WHERE id=5;"));
