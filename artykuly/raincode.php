...
if($_SESSION['ostatnie'][0] !== "Rain Code: Detektywistyczna Visual Novela" && $_SESSION['ostatnie'][1] !== "Rain Code: Detektywistyczna Visual Novela" && $_SESSION['ostatnie'][2] !== "Rain Code: Detektywistyczna Visual Novela") {
    ...
    $_SESSION['ostatnie'][0] = "Rain Code: Detektywistyczna Visual Novela";
    $_SESSION['link'][0] = "raincode.php";
    
}

$info1 = mysqli_fetch_row(mysqli_query($conn, "SELECT nazwa, link, nazwa_pliku, il_akapitow, akapit1, akapit2, akapit3, akapit4, akapit5 FROM artykuly WHERE id=6;"));
