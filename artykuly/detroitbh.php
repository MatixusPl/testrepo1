...
if($_SESSION['ostatnie'][0] !== "Do przyszłego miasta Detroit" && $_SESSION['ostatnie'][1] !== "Do przyszłego miasta Detroit" && $_SESSION['ostatnie'][2] !== "Do przyszłego miasta Detroit") {
    ...
    $_SESSION['ostatnie'][0] = "Do przyszłego miasta Detroit";
    $_SESSION['link'][0] = "detroitbh.php";
    
}


$info1 = mysqli_fetch_row(mysqli_query($conn, "SELECT nazwa, link, nazwa_pliku, il_akapitow, akapit1, akapit2, akapit3, akapit4, akapit5 FROM artykuly WHERE id=8;"));
