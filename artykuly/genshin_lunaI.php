...
if($_SESSION['ostatnie'][0] !== "Wyszło Genshin Luna I" && $_SESSION['ostatnie'][1] !== "Wyszło Genshin Luna I" && $_SESSION['ostatnie'][2] !== "Wyszło Genshin Luna I") {
    ...
    $_SESSION['ostatnie'][0] = "Wyszło Genshin Luna I";
    $_SESSION['link'][0] = "genshin_lunaI.php";
    
}

$info1 = mysqli_fetch_row(mysqli_query($conn, "SELECT nazwa, link, nazwa_pliku, il_akapitow, akapit1, akapit2, akapit3, akapit4, akapit5 FROM artykuly WHERE id=3;"));
