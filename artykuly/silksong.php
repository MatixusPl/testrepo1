...
if($_SESSION['ostatnie'][0] !== "Silksong wyszedł" && $_SESSION['ostatnie'][1] !== "Silksong wyszedł" && $_SESSION['ostatnie'][2] !== "Silksong wyszedł") {
    ...
    $_SESSION['ostatnie'][0] = "Silksong wyszedł";
    $_SESSION['link'][0] = "silksong.php";
    
}

$info1 = mysqli_fetch_row(mysqli_query($conn, "SELECT nazwa, link, nazwa_pliku, il_akapitow, akapit1, akapit2, akapit3, akapit4, akapit5 FROM artykuly WHERE id=1;"));
